          ...
          <div className="text-center lg:text-left max-w-4xl mx-auto lg:mx-0">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-12 max-w-2xl mx-auto lg:mx-0">
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                ...
                <div className="text-white font-semibold">November 9, 2025</div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <button className="bg-bitconf-primary text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-bitconf-primary/80 transition-all duration-300 shadow-lg hover:shadow-xl">
                Register Now
              </button>
              <button className="border-2 border-bitconf-accent text-bitconf-accent px-8 py-4 rounded-lg font-semibold text-lg hover:bg-bitconf-accent hover:text-white transition-all duration-300">
                View Schedule
              </button>
            </div>
          </div>
